...
rm -rf ./downloads ./geojson ./tiles ./unzipped ./merged-geojson ./aggregated-geojson ./tiled-aggregated ./aggregated-geojson ./aggregated-cleaned ./indexed ./cl_processed
mkdir ./downloads ./geojson ./tiles ./unzipped ./merged-geojson ./aggregated-geojson ./tiled-aggregated ./aggregated-geojson ./aggregated-cleaned ./indexed ./mbtiles ./cl_processed
...
then
    ...
    # luster unique GEOIDs in each zoom level.
    node --max_old_space_size=8192 cluster.js "$geolayer" "$year"
