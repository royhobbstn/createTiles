...
rm -rf ./downloads ./geojson ./tiles ./unzipped ./simple ./combined ./cl_processed ./cl_tiled
mkdir ./downloads ./geojson ./tiles ./unzipped ./simple ./combined ./cl_processed ./cl_tiled
...
then
    ...
    # use mapshaper to make a simple version
    
    # then combine them to a single file
